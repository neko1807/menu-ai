...
ระบบรองรับบัญชีผู้ใช้และเก็บชุดคำแนะนำเมนูไว้ใน PostgreSQL

ก่อนสร้างเมนู ระบบจะตรวจสอบวัตถุดิบที่กรอกกับ Gemini ก่อน หากพบสิ่งที่ไม่ใช่วัตถุดิบ เช่น ช้อนหรือกระป๋องเปล่า จะแจ้งผู้ใช้และเก็บรายการดังกล่าวไว้ในตาราง `invalid_ingredients` เพื่อใช้ตรวจได้ทันทีในการกรอกครั้งถัดไป โดยไม่เรียก AI ซ้ำ
